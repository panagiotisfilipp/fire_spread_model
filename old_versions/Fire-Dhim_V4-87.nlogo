...
to changeFire_Danger ;;NTC - with differeing cell size
      ...
      if view = "Hill Shade" [import-pcolors-rgb "PNG/HS_DHM_N.png"]
      ...
      if view = "Hill Shade" [import-pcolors-rgb "PNG/HS_DHM.png"]
...
;to choose base map layer visualisation
 if View = "Hill Shade" [import-pcolors-rgb "PNG/HS_DHM.png"] ask patches [if (burnt < 100) [set pcolor black] ]
...
to setup-patches
  import-pcolors-rgb "PNG/HS_DHM.png"
...
766
Average Burn
ask patches [ set pcolor scale-color red totalout 0 iteration]  
NIL
1
T
OBSERVER
