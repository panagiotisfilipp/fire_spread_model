...
airplanes-own [alert incoming-queue ];ουρές μηνυμάτων αεροσκαφών και ποσοτητα νερου που φέρουν πανω τους
sensors-own [alert incoming-queue];ουρές μηνυμάτων σενσορς
airbases-own [alert incoming-queue]
...
to move
  ifelse count embers with [color = 45] > 0 or count embers with [color = 15] > 0 [
