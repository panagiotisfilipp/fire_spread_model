...
airplanes-own [incoming-queue status  water fuel];ουρές μηνυμάτων αεροσκαφών και ποσοτητα νερου που φέρουν πανω τους
...
if fuel > 0[ set fuel fuel - 1]
if fuel <= 50[
ask airplanes [set status "refuel"]
]
end
; -----------------------------------------------------------------------------------
...
to do_refuel
 ...
 if (any? embers with [color = 45] or any? embers with [color = 15]) and  status = "refuel"[
